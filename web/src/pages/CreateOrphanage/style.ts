...
export const Container = styled.div`
    ...
    form.create-orphanage-form .input-block .img-wrapper {
        position: relative;
    }
    form.create-orphanage-form .input-block .img-wrapper button {
        position: absolute;
        top: 0;
        right: 0;
        display: flex;
    ...
    form.create-orphanage-form .input-block img {
        width: 100%;
        height: 96px;
        object-fit: cover;
        border-radius: 20px;
    }
    form.create-orphanage-form input[type=file] {
        display: none;
    }
